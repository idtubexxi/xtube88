...
<body
    class="bg-gradient-to-br from-primary-500 to-primary-700 dark:from-primary-900 dark:to-gray-900 min-h-screen flex items-center justify-center p-4">
    <div class="text-center">
        <h1 class="text-4xl sm:text-5xl lg:text-6xl font-bold text-white mb-4">Admin Dashboard</h1>
        <p class="text-lg sm:text-xl text-white/90 mb-8">Modern & Clean Dashboard dengan Laravel 12</p>

        <div class="space-y-4 sm:space-y-0 sm:space-x-4">
            @auth
                <a href="{{ route('admin.dashboard') }}"
                    class="inline-block bg-white text-primary-600 font-semibold px-6 sm:px-8 py-3 rounded-lg hover:bg-gray-100 transition w-full sm:w-auto">
                    Go to Dashboard
                </a>
            @else
                <a href="{{ route('login') }}"
        ...
        <div class="mt-12 text-white/80">
            <p class="text-sm">Built with ❤️ using Laravel 12 + Tailwind CSS</p>

            <!-- Dark Mode Toggle -->
            <button onclick="toggleDarkMode()"
                class="mt-4 inline-flex items-center text-sm text-white/80 hover:text-white transition">
